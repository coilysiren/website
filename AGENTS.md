...
- **Verify CI**: `ward ops forgejo actions task list --repo coilysiren/website --limit 1` should show `completed/success`. Re-schedule once at +180s if in progress; surface and stop on failure.
