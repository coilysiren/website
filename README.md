...
<https://www.coilysiren.me> site, building from the GitHub `release` branch
that a daily workflow fast-forwards to `main` ([deploy](docs/deploy.md)). The [staging image](docs/staging.md) supplies the
